...
-   Add disable_roles_acquisition and enable_roles_acquisition to
    api.content \[MrTango\]
...
-   Fix translation related tests to use the `plonelocales` domain
...
-   Removed dependency on Products.CMFPlone to avoid circular
